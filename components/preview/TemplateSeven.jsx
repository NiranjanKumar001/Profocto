...
/**
 * Template Seven - Minimalist Professional
 * Clean, ATS-friendly design with clear sections and excellent readability
...
const TemplateSeven = ({
  ...
  return (
    <div className="w-full h-full bg-white text-gray-900 p-8 print:p-6">
      {/* Header Section */}
            ...
            {resumeData.socialMedia.map((social, index) => {
              ...
              return (
                social.url && (
                  ...
                  >
                    {iconData && <span className="text-sm">{iconData.icon}</span>}
              ...
              <section key="skills" className="mb-6">
                ...
                <div className="space-y-2">
                  {technicalSkills.map((skillGroup, index) => (
                    <div key={index}>
                      <span className="font-semibold text-sm text-gray-900">{skillGroup.title}:</span>{" "}
