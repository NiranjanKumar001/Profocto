  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(125deg, #000000 0%, #1a1a2e 50%, #16213e 100%)",
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        <video
          ...
          style={{
            ...
            transform: `scale(1.05) translate(${mousePosition.x * 10}px, ${
              mousePosition.y * 10
            }px)`,
          }}
        >
          <source
            src="https://ik.imagekit.io/profocto/background.mp4?updatedAt=1759063890063"
            type="video/mp4"
          />
      ...
      <div
        className={`absolute z-[9999] top-4 sm:top-8 right-4 sm:right-8 z-20 text-white/80 text-xs sm:text-sm font-light tracking-wide text-right transition-all duration-500 hover:text-white ${inter.className}`}
      >
        {session ? (
      ...
      <div
        ref={containerRef}
        className="relative z-20 h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-4"
      >
        {/* Introducing Badge with animation */}
        <div className="mb-8 sm:mb-12 transform transition-all duration-700 hover:scale-105">
          <div
            className={`inline-flex items-center justify-center px-4 sm:px-6 py-2 rounded-full border border-white/30 bg-white/10 backdrop-blur-md transition-all duration-500 hover:bg-white/20 hover:border-white/40 ${inter.className}`}
          >
        ...
        <div
          className="text-center mb-12 sm:mb-16 transform transition-transform duration-1000"
          style={textTransform}
        >
          <div className="relative">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-full hidden xl:block">
              <div
                className={`text-white/30 text-lg font-light tracking-widest uppercase rotate-90 origin-center ${inter.className}`}
              >
                Creative
              </div>
            </div>
          ...
          <div className={`mt-8 sm:mt-16 space-y-1 ${inter.className}`}>
            <h2 className="text-white/80 text-sm sm:text-lg font-light tracking-wider uppercase transition-all duration-500 hover:text-white px-4 sm:px-0">
              {session
                ? "Your Resume Builder Dashboard"
                : "Professional Resume Builder & CV Creator"}
            </h2>
            <p className="text-white/60 text-xs sm:text-sm font-light tracking-wider uppercase transition-all duration-500 hover:text-white/80">
              {session
                ? "Create and manage your professional resumes with Profocto"
                : "Free Online Resume Maker with Elegant Templates - Powered by Profocto"}
            </p>
          </div>
        </div>
      ...
      <div className="absolute top-3/4 right-1/4 z-10 hidden md:block">
        <div
          className="w-1.5 h-1.5 bg-pink-400/30 rounded-full animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
      </div>
      <div className="absolute top-1/2 right-1/3 z-10 hidden lg:block">
        <div
          className="w-0.5 h-0.5 bg-pink-200/50 rounded-full animate-pulse"
